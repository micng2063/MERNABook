          ...
          <div class="row">
            <div class="col-md-4 mb-2">
              ...
              <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-secondary mb-2" href="/"><i class="fa fa-angle-right mr-2"></i>Terms and Conditions</a>
            ...
            <div class="col-md-3 mb-2">
              ...
              <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-secondary mb-2" href="/"><i class="fa fa-angle-right mr-2"></i>Find my Order</a>
